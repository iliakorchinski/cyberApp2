...
export default function HomePage(){
   return  <div className={classes.container}>
         <div className={classes.info}>
            ...
            <p className={classes['info-paragraph2']}>Created to change everything for the better.For everyone</p>
      
             <Link to='/products' className={classes['info-button']}>Shop Now</Link>  
